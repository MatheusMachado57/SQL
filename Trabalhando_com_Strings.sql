...
SELECT data, LENGTH(data) FROM temp_char;

CREATE TABLE temp_varchar (data VARCHAR(255));

INSERT INTO temp_varchar(data) VALUES('abc'), (' a ');

SELECT data, LENGTH(data) FROM temp_varchar;

CREATE TABLE assuntos (nome VARCHAR(40), corrente ENUM('arte', 'comercio', 'ciencia'));
...
CREATE TABLE usuarios (id_usuario INT UNSIGNED NOT NULL, preferencias JSON NOT NULL);

INSERT INTO usuarios(id_usuario, preferencias) VALUES(1, '{"pag_tamanho": 10, "gostos": {"esportes": 1}}');

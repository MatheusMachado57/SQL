...
Uma das boas práticas é sempre manter o usuário root inacessivel via remoto, e criar usuários com restições específicas para cada banco de dados ou tabelas de seu interesse.

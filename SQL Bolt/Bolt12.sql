...
# In SQL, the database schema is what describes the structure of each table, and the datatypes 
# that each column of the table can contain.

# Example: Correlated subquery
# For example, in our Movies table, the values in the Year column must be an Integer, 
# and the values in the Title column must be a String.

# This fixed structure is what allows a database to be efficient, and consistent despite 
# storing millions or even billions of rows.

# Inserting new data
# When inserting data into a database, we need to use an INSERT statement, which declares 
# which table to write into, the columns of data that we are filling, and one or more rows of 
# data to insert. In general, each row of data you insert should contain values for every 
# corresponding column in the table. You can insert multiple rows at a time by just listing 
# them sequentially.
...
# support default values, you can insert rows with only the columns of data you have by 
...
# Despite this being a more verbose statement to write, 
...
INSERT INTO Movies VALUES (15, 'Toy Story 4', 'Lee Unkrich', 2020, 100);
...
INSERT INTO Boxoffice VALUES (15, 8.7, 340000, 270000);
